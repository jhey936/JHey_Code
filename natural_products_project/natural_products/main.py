import sys
sys.path.append("/rds/homes/j/jch936/rds/RUNNING/natural_products_project/")
...
if __name__ == "__main__":
    ...
    MolFs = glob("mol_files/*.mol")

    # tree_cycles = tree_creation()
    # ring_counter = Counter()

    # database set up here
    db = Database("test_db", new_database=True)#, connect_string="mysql:///{}")
